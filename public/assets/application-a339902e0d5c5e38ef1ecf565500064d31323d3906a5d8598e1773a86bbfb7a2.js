  ...
  Notifications = (function() {
    ...
    Notifications.prototype.handleSuccess = function(data) {
      ...
      items = $.map(data, function(notification) {
        return "<li> <span class='item'> <span class='item-left'> <img src='http://lorempixel.com/50/50/'' alt='' /> <span class='item-info'> <span><%= FeedEntry.find(notification.notifiable_id).title %></span> </span> </span> </span> </li>";
      });
