class FeedEntriesController < ApplicationController
  ...
  def index
    ...
    @feed_entry = FeedEntry.where(feed_id: params[:feed_id]).order("published DESC").paginate(:page => params[:page], :per_page => 9)
  end
  ...
  private
    ...
    def feed_entry_params
      params.require(:feed_entry).permit(:feed_id, :title, :feed_entry_url, :published, :author, :feed_entry_content)
    end
end
